...
let _ =
	dispatch begin function
		| After_rules ->
			...
			rule "install" ~prod:"install" ~deps:["META"; "mpcap.cma"; "mpcap.cmxa"; "mpcap.a"]
				(fun _ _ -> Cmd (S[A"ocamlfind"; A"install"; A"mpcap"; A"META"; A"mpcap.cma"; A"mpcap.cmxa"; A"mpcap.mli"; A"mpcap.cmi"; A"mpcap.a"]));

			rule "uninstall" ~prod:"uninstall" ~deps:[]
				(fun _ _ -> Cmd (S[A"ocamlfind"; A"remove"; A"mpcap"]))
		| _ -> ()
	end
